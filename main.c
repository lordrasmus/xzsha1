...
int main( int argc, char** argv){
    ...
    const EVP_MD *md_db = EVP_get_digestbyname( "sha1" );
	EVP_MD_CTX* mdctx_db = EVP_MD_CTX_create();
	
    EVP_DigestInit_ex(mdctx_db, md_db, NULL);
	...
	unsigned int sha1_len = sizeof( sha1 );
